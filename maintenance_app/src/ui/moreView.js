/**
 * O mesmo estilo de quadrados da página principal. Oito quadrados grandes e
...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    label: 'Portas',
    tint: 'mv-ico-doors',
    icon: `<path d="M3 21h18"></path><path d="M6 21V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v17"></path><circle cx="15" cy="12" r="1"></circle>`
  },
  {
    target: 'sectors',
    label: 'Estádio',
